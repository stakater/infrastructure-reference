...
module "consul" {
  ...
  # Resource tags
  name = "${var.stack_name}-prod-consul"
...
resource "aws_security_group" "consul-sg-elb" {
  name_prefix = "${var.stack_name}-prod-elb-"
  vpc_id      = "${module.network.vpc_id}"
...
module "consul_scale_up_policy" {
  ...
  # Resource tags
  name = "${var.stack_name}-prod-consul-scaleup-policy"
...
module "consul_scale_down_policy" {
  ...
  # Resource tags
  name = "${var.stack_name}-prod-consul-scaledown-policy"
