...
BLUE_CLUSTER_DESIRED_SIZE=${10}
BLUE_GROUP_LOAD_BALANCERS=${11}
BLUE_GROUP_MIN_ELB_CAPACITY=${12}
GREEN_GROUP_AMI_ID=${13}
GREEN_CLUSTER_MIN_SIZE=${14}
GREEN_CLUSTER_MAX_SIZE=${15}
GREEN_CLUSTER_DESIRED_SIZE=${16}
GREEN_GROUP_LOAD_BALANCERS=${17}
GREEN_GROUP_MIN_ELB_CAPACITY=${18}
ENABLE_SSL=${19}
INTERNAL_SUPPORT=${20}
